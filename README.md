...
A two‑page Power BI project built end‑to‑end using SQL, Power Query, data modeling, and DAX.

Project Summary
A complete hospitality analytics dashboard that connects revenue performance with guest booking behavior. Built from scratch using SQL Server, Power BI, and DAX, this project turns raw hotel booking data into clear, actionable insights for revenue managers, operations teams, and hotel leadership.
...
I wanted to walk through the full BI workflow:
...
Hotels generate a lot of data, but decision makers rarely get a clear view of what’s happening. This dashboard was built to solve that gap by answering two core questions:
...
The goal was to create a report that supports real decisions around:
- pricing
- forecasting
- staffing
...
- support pricing and staffing decisions
...
5. Data Preparation
Exploration & Cleaning in SQL
I started by loading the dataset into SQL Server to understand its structure and quality.
SQL tasks included:
- checking for missing or inconsistent values
- standardizing text fields (segments, channels)
- removing or flagging invalid rows (negative ADR, zero nights)
...
The Date table was marked as the official date table to support time‑based DAX.

7. Core DAX Measures
A set of measures drives both pages:
...
This page answers: “How are we performing financially?”
...
<img width="1776" height="999" alt="Screenshot 2026-03-10 111150" src="https://github.com/user-attachments/assets/f0686f86-dbc9-4c32-9697-60d91cfb59a3" />
...
This page answers: “What are guests actually doing?”
...
<img width="1774" height="996" alt="Screenshot 2026-03-10 111352" src="https://github.com/user-attachments/assets/fe02a01e-0ad5-4e12-ae15-9b1e7edfc2fd" />

10. Key Insights
- Guests tend to book either very early (120+ days) or very close to arrival (0–30 days).
- The majority of stays are 2–3 nights, which is typical for leisure‑driven hotels.
...
- ADR dips in low‑season months, suggesting discounting or reduced demand.
These insights help leadership make decisions around pricing, forecasting, staffing, and channel strategy.

11. Challenges & Iteration
Throughout the build, I refined:
- sorting issues (bucket categories sorting alphabetically)
- DAX logic for ADR and cancellation rate
- category labels for readability
- visual titles for clarity
- color consistency
- layout spacing and alignment
Most improvements came from small, iterative adjustments, the same way dashboards evolve in real organizations.
...
My goal is simple:
turn raw data into something people can understand and act on.
This hospitality dashboard is a good example of how I like to work, start with messy data, clean it properly, build a solid model, and then design a report that tells a clear story.
